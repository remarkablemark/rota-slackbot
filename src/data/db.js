 ...
 */
exports.getRotations = function getRotations() {
  return Rota.find();
};
 ...
 */
exports.newRotation = function newRotation(rotaname, description) {
 ...
 */
exports.updateDescription = function updateDescription(rotaname, description) {
  return Rota.findOneAndUpdate(
    { name: rotaname },
    {
      description,
 ...
 */
exports.saveStaff = function saveStaff(rotaname, staffArr) {
  return Rota.findOneAndUpdate(
    { name: rotaname },
    {
      staff: staffArr,
 ...
 */
exports.saveAssignment = function saveAssignment(rotaname, usermention) {
  return Rota.findOneAndUpdate(
    { name: rotaname },
    {
 ...
 */
exports.getRotation = function getRotation(rotaname) {
 ...
 * @param {string} rotaname rotation name
 */
exports.deleteRotation = function deleteRotation(rotaname) {
